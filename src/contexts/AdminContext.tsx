...
const DEFAULT_UNITS: LayoutUnit[] = [
  ...
  { id: 'role-dashboard', name: 'Role 대시보드', component: 'RoleDashboard', enabled: true, order: 2, category: 'dashboard' },
  ...
  { id: 'filter', name: '필터 패널', component: 'FilterPanel', enabled: true, order: 7, category: 'search' },
  { id: 'resource-grid', name: '추천 도구 그리드', component: 'ResourceGrid', enabled: true, order: 8, category: 'content' },
  { id: 'related-resources', name: '관련 도구', component: 'RelatedResources', enabled: true, order: 9, category: 'content' },
  { id: 'url-input', name: '새 도구 추가', component: 'URLInputForm', enabled: true, order: 10, category: 'ingestion' },
  { id: 'trending-harvest', name: '트렌딩 수집', component: 'TrendingHarvestPanel', enabled: true, order: 11, category: 'ingestion' },
  { id: 'workflow-agent', name: '워크플로우 에이전트', component: 'WorkflowAgentPanel', enabled: true, order: 12, category: 'advanced' },
  { id: 'optimization-batch', name: '최적화 배치', component: 'OptimizationBatch', enabled: true, order: 13, category: 'advanced' },
  { id: 'activity-feed', name: '활동 피드', component: 'ActivityFeed', enabled: true, order: 14, category: 'advanced' },
];
