...
const DEFAULT_UNITS: LayoutUnit[] = [
  ...
  { id: 'goal-planner', name: '목표 기반 플래너', component: 'GoalPlanner', enabled: true, order: 2, category: 'planning' },
  { id: 'link-health', name: '링크 헬스 인디케이터', component: 'LinkHealthIndicator', enabled: true, order: 3, category: 'status' },
  { id: 'live-ops', name: '라이브 운영 바', component: 'LiveOpsBar', enabled: true, order: 4, category: 'status' },
  { id: 'error-message', name: '에러 메시지', component: 'ErrorMessage', enabled: true, order: 5, category: 'system' },
  { id: 'filter', name: '필터 패널', component: 'FilterPanel', enabled: true, order: 6, category: 'search' },
